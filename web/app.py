...
Servidor Flask responsavel pela interface com o usuario.
Recebe os parametros da pagina web, aciona o calculo via ctypes
e retorna a imagem PNG gerada.
"""
...
def create_colormap(iterations, max_iter):
    # pontos pertencentes ao conjunto (max_iter) sao pintados de preto
    # os demais recebem cor proporcional a velocidade de divergencia
...
def generate():
    # recebe parametros do JavaScript, delega o calculo ao C e retorna PNG
    try:
        ...
        # integracao Python-C: o calculo ocorre na biblioteca compilada
        ...
        # colorizacao e montagem da imagem sao feitas em Python
